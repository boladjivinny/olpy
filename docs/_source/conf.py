...
exclude_patterns = ['main.py', "main.rst"]
...
latex_documents = [
    (master_doc, 'OLPy.tex', 'OLPy Documentation',
     'Boladji Vinny', 'manual'),
]
...
man_pages = [
    (master_doc, 'olpy', 'OLPy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OLPy', 'OLPy Documentation',
     author, 'OLPy', 'One line description of project.',
     'Miscellaneous'),
]
